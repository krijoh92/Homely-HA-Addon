...
// biome-ignore lint/suspicious/noExplicitAny: required for recursive type-level flattening
					...
					? E extends Entry
						? {
								...
								optional: E["key"] extends ""
									? // biome-ignore lint/complexity/noBannedTypes: required for conditional type check
										{} extends Pick<T, K>
										? true
										: false
									: E["optional"];
